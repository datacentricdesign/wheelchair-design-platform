...
Adafruit_NeoPixel LED_controller = Adafruit_NeoPixel( 2, LED_PIN, NEO_RGB + NEO_KHZ800); 
...
void loop() {
  ...
  LED_controller.setPixelColor( 0, counter );
  LED_controller.setPixelColor( 1, counter );
